...
fun currentDeviceConfiguration(): DeviceConfiguration {
    ...
    return DeviceConfiguration.fromWindowSize(windowSize)
}
...
enum class DeviceConfiguration {
    ...
    companion object {
        fun fromWindowSize(windowSize: WindowSizeClass): DeviceConfiguration = with(windowSize) {
            when {
                ...
                minWidthDp >= WIDTH_DP_EXPANDED_LOWER_BOUND &&
                        minHeightDp in HEIGHT_DP_EXPANDED_LOWER_BOUND..HEIGHT_DP_EXPANDED_LOWER_BOUND -> TABLET_LANDSCAPE
